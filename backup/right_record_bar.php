...
<?php 
    ...
    //recommend
    $query = 'select * from users_account where userID <> '.$_SESSION['valid_userID'].' and city in (select city from users_account where userID='.$_SESSION['valid_userID'].') order by rand() LIMIT 3';
    $recommend_result = $db->query($query);
